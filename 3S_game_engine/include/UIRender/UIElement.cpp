...
namespace UIRender
{
    ...
    UIElement::UIElement(std::string vertexShaderPath, std::string fragmentShaderPath, Texture _texture, float leftPos, float rightPos, float bottomPos, float topPos)
        : uiShader(vertexShaderPath.c_str(), fragmentShaderPath.c_str()),
        uiTexture(_texture),
        uiVertices{
        //      x                       y            z    // texture coords
    ...
    void UIElement::setTexture(Texture _texture)
    {
        uiTexture = _texture;
    }
